...
const ToggleRow: React.FC<ToggleRowProps> = ({ label, description, checked, onChange, icon }) => (
  <div className="flex items-center justify-between gap-4 py-4">
    ...
    <button
      ...
      className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 ${
        checked ? "bg-brand-600 dark:bg-brand-500" : "bg-gray-200 dark:bg-slate-600"
      }`}
    >
...
const EditProfileModal: React.FC<EditProfileModalProps> = ({ initialName, initialPhone, onSave, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
      <div className="w-full max-w-md rounded-2xl border border-gray-100 bg-white shadow-2xl dark:border-slate-700 dark:bg-[#1e2535]">
        {/* Header */}
        ...
        <div className="flex flex-col items-center pt-8 pb-4">
          <div className="relative">
            ...
            <div className="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full border-2 border-white bg-brand-600 dark:border-slate-900">
        ...
        <div className="space-y-4 px-6 pb-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Your full name"
                className={`w-full rounded-xl border px-4 py-2.5 text-sm transition-all focus:outline-none focus:ring-2 focus:ring-brand-400 bg-gray-50 dark:bg-slate-800 dark:text-slate-200 dark:placeholder-slate-500 ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                maxLength={10}
                className={`w-full rounded-xl border pl-12 pr-4 py-2.5 text-sm transition-all focus:outline-none focus:ring-2 focus:ring-brand-400 bg-gray-50 dark:bg-slate-800 dark:text-slate-200 dark:placeholder-slate-500 ${
          ...
          {/* Info note */}
          <p className="rounded-xl bg-brand-50 px-3 py-2 text-xs text-brand-700 dark:bg-brand-600/10 dark:text-brand-400">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              ...
              className={`flex flex-1 items-center justify-center gap-2 rounded-xl py-2.5 text-sm font-semibold text-white transition-all disabled:opacity-70 ${
                saved ? "bg-accent-500" : "bg-brand-600 hover:bg-brand-700 dark:bg-brand-500 dark:hover:bg-brand-600"
              }`}
            >
...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col bg-[#F8FAFC] dark:bg-[#0F172A] min-h-full">
      ...
      <div className="flex-1 p-6 max-w-xl">
        ...
        {/* Profile card */}
        <section className="mb-5 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-card dark:border-slate-700 dark:bg-[#1e2535]">
          ...
          <div className="flex items-center gap-4 px-5 py-5">
            ...
            <div className="relative shrink-0">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-brand-gradient text-2xl font-bold text-white shadow-md">
                {initials}
              </div>
              <div className="absolute -bottom-0.5 -right-0.5 flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-brand-600 dark:border-slate-800">
          ...
          <div className="border-t border-gray-100 dark:border-slate-700 px-5 py-3">
            <button
              ...
              className="flex w-full items-center justify-between py-1.5 text-sm font-medium text-gray-600 transition-colors hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400"
            >
        ...
        <section className="mb-5 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-card dark:border-slate-700 dark:bg-[#1e2535]">
          ...
          <div className="divide-y divide-gray-100 px-5 dark:divide-slate-700">
            <button className="flex w-full items-center justify-between py-3.5 text-sm font-medium text-gray-600 transition-colors hover:text-brand-600 dark:text-slate-400 dark:hover:text-brand-400">
